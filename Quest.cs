...
namespace Gorilla_Quests
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void InitializeQuests()
        {
            ...
            foreach (string map in maps)
            {
                // Advanced quests - Play for 10 minutes in each map
            ...
            foreach (string map in maps)
            {
                // Expert quests - Play for 15 minutes in each map
        ...
        void SelectRandomQuest(Quest completedQuest, QuestType questType)
        {
            if (selectedQuests.Contains(completedQuest))
            {
                ...
                // Use weighted selection based on the quest type
                switch (questType)
                {
       ...
       private void CheckAndStartCountQuest()
{
    try
    {
        // Filter the quests to only those where Count is true
